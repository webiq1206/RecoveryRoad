...
const DEFAULT_REQUIREMENTS: ComplianceRequirement[] = [
  {
    ...
    description: 'Complete your daily recovery check-in to confirm engagement',
    frequency: 'daily',
    requiredTime: '09:00',
    windowMinutes: 120,
    isActive: true,
  },
  {
    ...
    description: 'Submit a breath analysis reading via connected device',
    frequency: 'daily',
    requiredTime: '08:00',
    windowMinutes: 60,
    isActive: true,
  },
  {
    ...
    description: 'Confirm your location for scheduled verification windows',
  ...
  },
  {
    ...
    description: 'Attend required recovery or court-mandated meetings',
    frequency: 'weekly',
    requiredTime: '18:00',
    windowMinutes: 180,
    isActive: true,
  },
  {
    ...
    description: 'Confirm you are at your registered address during curfew hours',
    frequency: 'daily',
    requiredTime: '23:00',
    windowMinutes: 15,
    isActive: false,
    ...
    if (!hasCompleted) {
      ...
      if (now > deadlineDate) {
        alerts.push({
          ...
          message: `You missed your ${req.title.toLowerCase()} for today. Contact your officer if needed.`,
